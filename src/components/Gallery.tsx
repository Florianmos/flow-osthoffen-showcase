...
const Gallery = () => {
  ...
  const photos = [
    { id: 1, url: "https://images.unsplash.com/photo-1571266028243-d220c6eb8e8f?w=800", alt: "DJ Setup 1" },
    { id: 2, url: "https://images.unsplash.com/photo-1598387181032-a3103a2db5b1?w=800", alt: "Event 1" },
    { id: 3, url: "https://images.unsplash.com/photo-1574391884720-bbc3740c59d1?w=800", alt: "Wedding Event" },
    { id: 4, url: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=800", alt: "Party Night" },
    { id: 5, url: "https://images.unsplash.com/photo-1540039155733-5bb30b53aa14?w=800", alt: "Club Event" },
    { id: 6, url: "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800", alt: "Concert Setup" },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Découvrez mes dernières prestations et l'ambiance que je crée pour vos événements
          </p>
        </div>

        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full max-w-md mx-auto grid-cols-2 mb-12 bg-card">
            <TabsTrigger value="photos" className="data-[state=active]:bg-gradient-primary data-[state=active]:text-background">
              <Image className="w-4 h-4 mr-2" />
              Photos
            </TabsTrigger>
            <TabsTrigger value="videos" className="data-[state=active]:bg-gradient-primary data-[state=active]:text-background">
                ...
                >
                  <div className="relative aspect-square overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-background/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                      <p className="text-foreground font-semibold">{photo.alt}</p>
                    </div>
                  </div>
                </Card>
              ))}
